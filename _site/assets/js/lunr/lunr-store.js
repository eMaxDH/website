var store = [{
        "title": "Magic Leap",
        "excerpt":"“Can you share some of your thoughts on #photonics as it relates to spacial computing (i.e. Magic Leap)?”[1] My first thought was, how does the display work? I found a patent from Magic Leap, Inc. Maybe the Magic Leap One works like this =) In order to obtain a real...","categories": ["optics","qoto"],
        "tags": [],
        "url": "/optics/qoto/magic-leap/",
        "teaser": null
      },{
        "title": "Smart Wall",
        "excerpt":"I read about a new smart wall (glass) from NanaWall [1]. I was wondering how it worked. So far I only learned something about nematic liquid crystal displays (LCD). With the following cell configurations Fréedericksz cell, VA cell, twisted nematic LC cell (similar to the Fréedericksz cell). I read a...","categories": ["optics","qoto"],
        "tags": [],
        ...
        "excerpt":"Ingredients      Leek   Flaky Pastry  ","categories": [],
        "tags": [],
        "url": "/recipes/leek-casserole/",
        "teaser": null
      },{
